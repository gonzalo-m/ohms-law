...
//
//    private Voltage v() {
//        return mCalcView.getPresenter().getModel().getVoltage();
//    }
//
//    private Current i() {
//        return mCalcView.getPresenter().getModel().getCurrent();
//    }
//
//    private Resistance r() {
//        return mCalcView.getPresenter().getModel().getResistance();
//    }
//
//    private Power p() {
//        return mCalcView.getPresenter().getModel().getPower();
//    }
}
